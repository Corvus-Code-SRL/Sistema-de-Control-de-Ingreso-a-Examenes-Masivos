  ...
  return (
    ...
    >
      <div className="p-4 md:p-8 relative h-full flex flex-col gap-6 font-inter bg-background">
        ...
        {/* Cabecera usando el componente del líder */}
        <PageHeader
          title="Cuentas"
          subtitle="Personas con acceso a SCIEM. El tipo institucional viene del SIS y define qué roles puede recibir cada cuenta."
          actions={
            <button 
        ...
        <AsignarRolModal 
          ...
          onSuccess={() => setIsAsignarRolOpen(false)}
